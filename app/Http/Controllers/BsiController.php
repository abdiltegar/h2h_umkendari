...
class BsiController extends Controller
{
    ...
    function Index(Request $request) {
        ...
        $auth = $bankUseCase->CheckSumBsi($kodeBank, $bank->password, $nomorPembayaran, $tanggalTransaksi, $totalNominalStr, $checksum);
        if(!$auth){
    ...
    function Generate(Request $request) {
        return \sha1("".$request->nomorPembayaran."".$request->secretKey."".$request->tanggalTransaksi."".$request->totalNominal."");
    }
